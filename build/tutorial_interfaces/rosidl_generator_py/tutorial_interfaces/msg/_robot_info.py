    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'tutorial_interfaces.msg.RobotInfo')
            logger.debug(
...
class RobotInfo(metaclass=Metaclass_RobotInfo):
    ...
    def __init__(self, **kwargs):
        ...
        from geometry_msgs.msg import Twist
        self.speed = kwargs.get('speed', Twist())
        from geometry_msgs.msg import Point
        self.position = kwargs.get('position', Point())
        from geometry_msgs.msg import Quaternion
        self.orientation = kwargs.get('orientation', Quaternion())
        self.front_range = kwargs.get('front_range', float())
    ...
    def __eq__(self, other):
        ...
        if self.orientation != other.orientation:
            return False
        if self.front_range != other.front_range:
            return False
        return True
    ...
    def speed(self, value):
        if __debug__:
            ...
            assert \
                ...
                "The 'speed' field must be a sub message of type 'Twist'"
        self._speed = value
    ...
    def front_range(self):
        """Message field 'front_range'."""
        return self._front_range

    @front_range.setter
    def front_range(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'front_range' field must be of type 'float'"
        self._front_range = value
