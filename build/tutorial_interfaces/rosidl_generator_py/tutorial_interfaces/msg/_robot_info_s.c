...
bool tutorial_interfaces__msg__robot_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tutorial_interfaces.msg._robot_info.RobotInfo", full_classname_dest, 45) == 0);
  }
  tutorial_interfaces__msg__RobotInfo * ros_message = _ros_message;
  {  // speed
    PyObject * field = PyObject_GetAttrString(_pymsg, "speed");
    if (!field) {
      return false;
    }
    if (!geometry_msgs__msg__twist__convert_from_py(field, &ros_message->speed)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // front_range
    PyObject * field = PyObject_GetAttrString(_pymsg, "front_range");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->front_range = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
PyObject * tutorial_interfaces__msg__robot_info__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("tutorial_interfaces.msg._robot_info");
  ...
  {  // speed
    PyObject * field = NULL;
    field = geometry_msgs__msg__twist__convert_to_py(&ros_message->speed);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // front_range
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->front_range);
    {
      int rc = PyObject_SetAttrString(_pymessage, "front_range", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
