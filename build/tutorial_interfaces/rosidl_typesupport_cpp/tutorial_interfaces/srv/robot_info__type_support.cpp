...
static const _RobotInfo_Request_type_support_symbol_names_t _RobotInfo_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tutorial_interfaces, srv, RobotInfo_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tutorial_interfaces, srv, RobotInfo_Request)),
  }
};
...
{
  return &::tutorial_interfaces::srv::rosidl_typesupport_cpp::RobotInfo_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, tutorial_interfaces, srv, RobotInfo_Request)() {
  return get_message_type_support_handle<tutorial_interfaces::srv::RobotInfo_Request>();
}
...
static const _RobotInfo_Response_type_support_symbol_names_t _RobotInfo_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tutorial_interfaces, srv, RobotInfo_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tutorial_interfaces, srv, RobotInfo_Response)),
  }
};
...
{
  return &::tutorial_interfaces::srv::rosidl_typesupport_cpp::RobotInfo_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, tutorial_interfaces, srv, RobotInfo_Response)() {
  return get_message_type_support_handle<tutorial_interfaces::srv::RobotInfo_Response>();
}
...
static const _RobotInfo_type_support_symbol_names_t _RobotInfo_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tutorial_interfaces, srv, RobotInfo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tutorial_interfaces, srv, RobotInfo)),
  }
};
...
{
  return &::tutorial_interfaces::srv::rosidl_typesupport_cpp::RobotInfo_service_type_support_handle;
}
