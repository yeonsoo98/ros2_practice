...
#include "tutorial_interfaces/srv/detail/robot_info__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const tutorial_interfaces::srv::RobotInfo_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tutorial_interfaces::srv::RobotInfo_Request & ros_message)
{
  // Member: arithmetic_operator
  cdr >> ros_message.arithmetic_operator;
...
{
  auto typed_message =
    static_cast<const tutorial_interfaces::srv::RobotInfo_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tutorial_interfaces::srv::RobotInfo_Request *>(
    untyped_ros_message);
...
{
  return &tutorial_interfaces::srv::typesupport_fastrtps_cpp::_RobotInfo_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tutorial_interfaces, srv, RobotInfo_Request)() {
  return &tutorial_interfaces::srv::typesupport_fastrtps_cpp::_RobotInfo_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_tutorial_interfaces
cdr_serialize(
  const tutorial_interfaces::srv::RobotInfo_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tutorial_interfaces::srv::RobotInfo_Response & ros_message)
{
  // Member: arithmetic_result
  cdr >> ros_message.arithmetic_result;
...
{
  auto typed_message =
    static_cast<const tutorial_interfaces::srv::RobotInfo_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<tutorial_interfaces::srv::RobotInfo_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &tutorial_interfaces::srv::typesupport_fastrtps_cpp::_RobotInfo_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tutorial_interfaces, srv, RobotInfo_Response)() {
  return &tutorial_interfaces::srv::typesupport_fastrtps_cpp::_RobotInfo_Response__handle;
}
...
{
  return &tutorial_interfaces::srv::typesupport_fastrtps_cpp::_RobotInfo__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tutorial_interfaces, srv, RobotInfo)() {
  return &tutorial_interfaces::srv::typesupport_fastrtps_cpp::_RobotInfo__handle;
}
